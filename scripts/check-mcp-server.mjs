...
try {
	...
	const expected = ["actor_session", "claim_resource", "open_root", "execute_goal", "find_roots", "observe_ui", "search_ui", "expand_ui", "inspect_ui", "act_ui", "execute_plan", "read_text", "wait_for", "subscribe_ui", "read_ui_events", "unsubscribe_ui"];
