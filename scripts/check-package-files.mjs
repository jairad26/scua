...
for (const required of [".codex-plugin", ".mcp.json", "mcp", "scripts/run-mcp.sh"]) {
...
for (const required of [".codex-plugin/plugin.json", ".mcp.json", "mcp/server.ts", "mcp/tool-catalog.ts", "mcp/compact.ts", "scripts/run-mcp.sh"]) {
